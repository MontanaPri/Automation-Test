...
Feature: BTRIS EKG Test Report
  ...
  #Login to the system.
    ...
    Examples:
      ...
      | BTRIS-TEST-05 | btris_test2 | NIHCCTEST        | EKG Parameter Measurement (CPT Code 93000.5, No Name Provided by Source) (CC, EKG) | Electrocardiogram (EKG, ECG) Observation | Electrocardiogram Impression (CC, EKG) | Electrocardiogram Interpreting Physician (CC, EKG) | Electrocardiogram Location (CC, EKG) |



  @EKG_Test_SC3

  Scenario Outline: 12.3 EKG Report testing with ALL Observations and Shopping Cart.
  #Login to the system.
    Given the user navigates to / on browser
    And the user must see "Log in to BTRIS" text in "btris home: landing page" field on "Btris/Portal" page
    #Login to the BTRIS system.
    ...
    And the user must see "EKG Criteria" text in "btris: ekg report page" field on "Btris/Portal" page
    And the user enters "<EKG Start Date>" into "ekg start date" on "Btris/Portal" page
    And the user enters "Todays Date" into "ekg end date" on "Btris/Portal" page
    #Clcik on the select report button.
    ...
    Examples:
      | Subject       | User_Name   | Filtered Subject | Subject 1     | EKG Start Date | EKG Observations 1                                                                 | EKG Observations 2                       | EKG Observations 3                     | EKG Observations 4                                 | EKG Observations 5                   |
      | BTRIS-TEST-05 | btris_test2 | NIHCCTEST        | BTRIS-TEST-01 | 5/16/2006      | EKG Parameter Measurement (CPT Code 93000.5, No Name Provided by Source) (CC, EKG) | Electrocardiogram (EKG, ECG) Observation | Electrocardiogram Impression (CC, EKG) | Electrocardiogram Interpreting Physician (CC, EKG) | Electrocardiogram Location (CC, EKG) |
