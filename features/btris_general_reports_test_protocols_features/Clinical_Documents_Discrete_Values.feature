...
Feature: BTRIS Clinical Documents - Discrete Values Test Report
  ...
  #Login to the system.
    ...
    And the user remembers the value of "clinical documents: discrete report page" field into "Results Preview - Standard" on "Btris/Portal" page
    And the user verify if the report failed
    And the user remembers the value of "reports results" field into "Loaded Report" on "Btris/Portal" page
    #Verify and validate the report display and click on the the image to view.
    And the user remembers the value of "clinical doc dv admin results" field into "Loaded Clinical Documents Discrete Values Results" on "Btris/Portal" page
  ...
  @ClinicalDocuments_SC2

  Scenario Outline: 4.2 Clinical Documents - Discrete Values verification of the shopping Cart.
  #Login to the system.
    Given the user navigates to / on browser
    And the user must see "Log in to BTRIS" text in "btris home: landing page" field on "Btris/Portal" page
    #Login to the BTRIS system.
    ...
    And the user remembers the value of "btris: clinical documents: discrete values filter report page" field into "Criteria Page" on "Btris/Portal" page
    And the user must see "Clinical Documents - Discrete Values Criteria" text in "btris: clinical documents: discrete values filter report page" field on "Btris/Portal" page
    And the user enters "<Meds Order Start Date>" into "clinical documents start date" on "Btris/Portal" page
    And the user enters "Todays Date" into "clinical documents end date" on "Btris/Portal" page
    #Clcik on the select report button.
    And the user clicks on "btris: top select subject button" element on "Btris/Portal" page
    #Enter and filter subject.
    And the user enters "<Subject>" into "fine protocol and subject search box" on "Btris/Portal" page
    ...
    Examples:
      ...
      | BTRIS-TEST-04 | btris_test2 | NIHCCTEST        | 4/10/2007             | BTRIS-TEST-05 |


  @ClinicalDocuments3

  Scenario Outline: 4.3 Clinical Documents - Discrete Values with red search for Clinical documentsi.
  #Login to the system.
    Given the user navigates to / on browser
    And the user must see "Log in to BTRIS" text in "btris home: landing page" field on "Btris/Portal" page
    #Login to the BTRIS system.
    ...
    Examples:
      | Subject       | User_Name   | Filtered Subject | Red Search Data | Search Type                    | Red Search Data 1                  | Search Type 1                  | Search Type 2                     | Red Search Data 2 | Search Type 3 | Red Search Data 3                                  | Red Search Data 4              | Red Search Data 5              | Red Search Data 6 |
      | BTRIS-TEST-04 | btris_test2 | NIHCCTEST        | Potassium Test  | Contains any of these keywords | Serial Research Testing (CC, CRIS) | Contains all of these keywords | Starts with any of these keywords | Serial (CC, CRIS) | Exact Phrase  | Serial Testing or Serial/Research Testing Document | Glasgow Coma Scale Observation | Glasgow Coma Scale Observation | Body  DTM         |


  @ClinicalDocuments3

  Scenario Outline: 4.4 Clinical Documents - Discrete Values with red search for Clinical documentsi.
  #Login to the system.
    Given the user navigates to / on browser
    And the user must see "Log in to BTRIS" text in "btris home: landing page" field on "Btris/Portal" page
    #Login to the BTRIS system.
