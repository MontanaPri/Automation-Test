...
Feature: BTRIS Laboratory Test Report
  ...
  Scenario Outline: 2.3 Laboratory Shopping Cart Test Reports.
  #Login to the system.
    Given the user navigates to / on browser
    And the user must see "Log in to BTRIS" text in "btris home: landing page" field on "Btris/Portal" page
    #Login to the BTRIS system.
    ...
    Examples:
      | Subject       | User_Name   | Filtered Subject | Subject 1     | Lab Collection Start Date |
      | BTRIS-TEST-03 | btris_test2 | NIHCCTEST        | BTRIS-TEST-03 | 5/15/2006                 |
