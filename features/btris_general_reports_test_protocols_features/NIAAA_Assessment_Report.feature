...
Feature: BTRIS NIAAA Assessment Test Report
 ...
 #Login to the system.
    ...
    Examples:
      | Subject    | User_Name   | Filtered Subject | Assessments                               |
      | 13-AA-0040 | btris_test2 | ALLEN            | Addiction Severity Index (NIAAA, ASM_ASI) |
  ...
  #Login to the system.
    ...
    Examples:
      | Subject    | User_Name   | Filtered Subject | Assessments                               |
      | 08-AA-0137 | btris_test2 | ADEBISI          | Addiction Severity Index (NIAAA, ASM_ASI) |


  @NIAAA_SC3

  Scenario Outline: 1.3 NIAAA Assessment Shopping Cart Report testing with ALL assessment.
  #Login to the system.
    Given the user navigates to / on browser
    And the user must see "Log in to BTRIS" text in "btris home: landing page" field on "Btris/Portal" page
    #Login to the BTRIS system.
    ...
    And the user must see "NIAAA Assessment Report Criteria" text in "btris: assessment filter report page" field on "Btris/Portal" page
    And the user enters "<Meds Order Start Date>" into "niaaa assessment start date" on "Btris/Portal" page
    And the user enters "Todays Date" into "niaaa assessment end date" on "Btris/Portal" page
    #Clcik on the select report button.
    And the user clicks on "btris: top select subject button" element on "Btris/Portal" page
    #Enter and filter subject.
    And the user enters "<Subject>" into "fine protocol and subject search box" on "Btris/Portal" page
    ...
    Examples:
      | Subject    | User_Name   | Filtered Subject | Meds Order Start Date | Subject 1  | Assessments                               |
      | 08-AA-0137 | btris_test2 | ADEBISI          | 4/10/2007             | 11-AA-0010 | Addiction Severity Index (NIAAA, ASM_ASI) |