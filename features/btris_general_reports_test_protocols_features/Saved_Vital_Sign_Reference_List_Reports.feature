...
@Vital_Sign_Reference_List_Saved_Reports
Feature: BTRIS Vital Sign Reference List Saved Reports


  @Vital_Signs_Saved_Reports-1

  Scenario Outline: 1.1 Adding, Editing and deleting Vital Signs Reference List Saved Reports Criteria, 12 days.
  #Login to the system.
    ...
    And the user remembers the value of "vital sign rl saved report" field into "Saved Reports Table" on "Save/Reports" page
    ...
    Examples:
      ...
      | T - Vital Signs Template1 | btris_test4 | 5                | 230                   | T - Reference List DN | 230                  | Vital Sign RL Report | 1234 0 Automation Testing | There was 1 error with your submission: | 200                          | 201                         | 10                      | BTRIS_TEST2 - TEST2 null | Vital Signs | First_Vital_Sign_Search_Term_List_New.xlsx | MM/DD/YYYY          | Vital_Signs_Reference_List_New.xlsx | Reference List DN  | Vital Signs Template1 |


  @Vital_Signs_Saved_Reports-2

  Scenario Outline: 1.2 Copy Vital Signs Reference List Saved Reports Criteria, 15 days.
  #Login to the system.
    Given the user navigates to / on browser
    And the user must see "Log in to BTRIS" text in "btris home: landing page" field on "Btris/Portal" page
    #Login to the BTRIS system.
    ...
    Examples:
      ...
      | T - Vital Signs Template1 | btris_test4 | 5                | 230                   | T - Reference List DN | 230                  | Vital Sign RL Report | 1234 0 Automation Testing | There was 1 error with your submission: | Copy of Vital Sign RL Report | BTRIS_TEST2 - TEST2 null | Vital Signs | First_Vital_Sign_Search_Term_List_New.xlsx | MM/DD/YYYY          | Vital_Signs_Reference_List_New.xlsx | Reference List DN  | Vital Signs Template1 |
