...
Feature: BTRIS Manage Protocol Test Report
  ...
  #Login to the system.
    ...
    Examples:
      | Protocol      | User_Name   |
      | BTRIS-TEST-00 | btris_test2 |
      | 00-C-0154     | btris_test2 |
      | 00-C-0074     | btris_test2 |
      | BTRIS-TEST-02 | btris_test2 |
      | BTRIS-TEST-04 | btris_test2 |
  ...
  Scenario Outline: 1.3 Managing and existing subject in a protocol.
  #Login to the system.
    ...
    Examples:
      ...
      | BTRIS-TEST-05 | btris_test2 | 9990112 | About Initial Consent |

  @AddSubjects1.3

  Scenario Outline: 1.4 Adding an Invalid subject to an existing protocol using MRN.
  #Login to the system.
    Given the user navigates to / on browser
    And the user must see "Log in to BTRIS" text in "btris home: landing page" field on "Btris/Portal" page
    #Login to the BTRIS system.
  ...
  Scenario Outline: 1.5 Adding an MRN that already exist to a protocol.
  #Login to the system.
    Given the user navigates to / on browser
    And the user must see "Log in to BTRIS" text in "btris home: landing page" field on "Btris/Portal" page
    #Login to the BTRIS system.
    ...
    Examples:
      ...
      | BTRIS-TEST-00 | btris_test2 | 3448411 | We've noticed that 1 MRN is already in BTRIS-TEST-00. | The following 1 records are ready to be added to protocol BTRIS-TEST-00 |

  @AddSubjects1.5

  Scenario Outline: 1.6 Adding a valid MRN to a protocol.
  #Login to the system.
    Given the user navigates to / on browser
    And the user must see "Log in to BTRIS" text in "btris home: landing page" field on "Btris/Portal" page
    #Login to the BTRIS system.
    ...
    Examples:
      ...
      | BTRIS-TEST-04 | btris_test2 | The following 1 records are ready to be added to protocol BTRIS-TEST-04 | 4018898 | Success!                      | We've noticed that 1 MRN is already in | No subjects found           |
      | BTRIS-TEST-04 | btris_test2 | The following 1 records are ready to be added to protocol BTRIS-TEST-04 | 4018886 | Success!                      | We've noticed that 1 MRN is already in | No subjects found           |