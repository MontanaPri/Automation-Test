...
@Clinical_Documents_Full_Auto_Test
Feature: BTRIS Clinical Documents - Full Text Test Report

  @ClinicalDocumentsFull_Autoe_Test1.1
  ...
  #Login to the system.
    ...
    And the user remembers the value of "clinical documents full tex result page" field into "Results Preview - Standard" on "Btris/Portal" page
    ...
    Examples:
      | Subject   | User_Name   | Filtered Subject | Validation Record |
      | 00-C-0133 | btris_test2 | BEATON           | No records found  |
