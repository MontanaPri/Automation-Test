...
@Echocardiogram_Test_Auto_Test
Feature: BTRIS Echocardiogram Test Report

  @Echocardiogram_Auto_Test.1
  ...
  #Login to the system.
    ...
    And the user remembers the value of "echocardiogram result page" field into "Results Preview - Standard" on "Btris/Portal" page
