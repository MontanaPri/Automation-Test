...
@NICHD_CTDB_Report_Test_Auto_Test
Feature: BTRIS NICHD - CTDB Report Test Report

  @NICHD_CTDB_Report_Auto_Test1
  ...
  #Login to the system.
    ...
    And the user remembers the value of "nichd ctdb forms report page" field into "Results Preview - Standard" on "Btris/Portal" page
