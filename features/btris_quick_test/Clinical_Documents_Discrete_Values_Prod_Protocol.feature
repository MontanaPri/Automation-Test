...
@Clinical_Documents_Discrete_Auto_Test
Feature: BTRIS Clinical Documents - Discrete Values Test Report

  @ClinicalDocuments_Auto_Test1.1
  ...
  #Login to the system.
    ...
    And the user remembers the value of "clinical documents: discrete report page" field into "Clinical Documents - Discrete Values Results Preview - Standard" on "Btris/Portal" page
