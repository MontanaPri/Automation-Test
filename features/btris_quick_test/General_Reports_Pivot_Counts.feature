...
Feature: BTRIS Pivot Counts General Test Report
  ...
  #Login to the system.
    ...
    And the user remembers the value of "ekg result page" field into "Results Preview - Standard" on "Btris/Portal" page
    #Verify report page.
  ...
  #Login to the system.
    ...
    And the user clicks on "run report button" element on "Btris/Portal" page
    Then the user verify if the report is unable to run with message
    And the user remembers the value of "laboratory and procedure report page" field into "Results Preview - Standard" on "Btris/Portal" page
    ...
    Examples:
      | Subject       | User_Name   | Filtered Subject | Pivot 1                  | Pivot 2                           | Pivot 0  | Pivot 3      | Pivot 4             | Pivot 5                             | Pivot 6                           |
      | BTRIS-TEST-03 | btris_test2 | NIHCCTEST        | Pivot By Day & Order Set | Pivot By Day & Order Set Detail 1 | Standard | Pivot By Day | Pivot By Day & Time | Pivot By Day & Time (w/o UOM Range) | Pivot By Day & Order Set Detail 2 |
