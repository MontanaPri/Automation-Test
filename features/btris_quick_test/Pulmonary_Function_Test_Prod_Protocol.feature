...
@Pulmonary_Function_Auto_Test
Feature: BTRIS Pulmonary Function Test Report

  @PulmonaryFT_Auto_Test1
  ...
  #Login to the system.
    ...
    And the user remembers the value of "pulmonary result report page" field into "Results Preview - Standard" on "Btris/Portal" page
