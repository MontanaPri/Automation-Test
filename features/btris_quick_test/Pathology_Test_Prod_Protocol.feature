...
@Pathology_Test_Auto_Test
Feature: BTRIS Pathology Test Report

  @Pathology_Auto_Test1
  ...
  #Login to the system.
    ...
    And the user remembers the value of "pathology result page" field into "Results Preview - Standard" on "Btris/Portal" page
    ...
    Examples:
      ...
      | 00-C-0078 | btris_test2 | ALDERMAN         |
