...
@Microbiology_Test_Auto_Test
Feature: BTRIS Microbiology Test Report

  @Microbiology_Smoke_Auto1
  ...
  #Login to the system.
    ...
    And the user remembers the value of "microbiology result page" field into "Results Preview - Standard" on "Btris/Portal" page
