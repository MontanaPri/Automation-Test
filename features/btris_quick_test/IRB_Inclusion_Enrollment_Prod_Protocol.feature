...
@IRB_Inclusion_Enrollment_Auto_Test
Feature: BTRIS IRB Inclusion Enrollment Test Report

  @IRBInclusionEnrollment_Prod_Data_Auto1
  ...
  #Login to the system.
    ...
    And the user verify that the protocol is available
    ...
    And the user remembers the value of "irb inclusion enrollment result page" field into "Results Preview - Standard" on "Btris/Portal" page
