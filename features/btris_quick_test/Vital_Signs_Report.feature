...
@Vital_Signs_Report_Auto_Test1
Feature: BTRIS Vital Signs Test Report

  @VitalSign_Auto_Test1
  ...
  #Login to the system.
    ...
    And the user remembers the value of "vital signs test result page" field into "Results Preview - Standard" on "Btris/Portal" page
