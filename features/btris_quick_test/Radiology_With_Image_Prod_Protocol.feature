...
@Radiology_With_Image_Auto_Test
Feature: BTRIS Radiology Test Report

  @Radiology_Auto_Test1
  ...
  #Login to the system.
    ...
    And the user remembers the value of "radiology report page" field into "Results Preview - Standard" on "Btris/Portal" page
    ...
    Examples:
      ...
      | 00-C-0069 | btris_test2 | AABERG           |


  @Radiology_Auto_Test2
  ...
  #Login to the system.
    ...
    #Click on the download report button.
    And the user clicks on "download full report button" download on "Btris/Portal" page
