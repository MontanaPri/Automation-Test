...
@Medication_Report_Auto_Test
Feature: BTRIS Medication Test Report

  @Medication_Smoke_AutoR1
  ...
  #Login to the system.
    ...
    And the user remembers the value of "medication report page" field into "Results Preview - Standard" on "Btris/Portal" page
