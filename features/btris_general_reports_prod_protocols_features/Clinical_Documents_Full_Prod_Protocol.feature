...
Feature: BTRIS Clinical Documents - Full Text Feature Prod Data
  ...
  #Login to the system.
    ...
    Examples:
      ...
      | 00-C-0133 | btris_test2 | BEATON           | Potassium Test  | Contains any of these keywords | Serial Research Testing (CC, CRIS) | Contains all of these keywords | Starts with any of these keywords | Serial (CC, CRIS) | Exact Phrase  | Serial Testing or Serial/Research Testing Document |