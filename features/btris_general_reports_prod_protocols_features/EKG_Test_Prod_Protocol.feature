  ...
  #Login to the system.
   #Login to the system.
    ...
    Examples:
      ...
      | 00-C-0133 | btris_test2 | NIHCCTEST        | EKG Parameter Measurement (CPT Code 93000.5, No Name Provided by Source) (CC, EKG) | Electrocardiogram (EKG, ECG) Observation | Electrocardiogram Impression (CC, EKG) | Electrocardiogram Interpreting Physician (CC, EKG) | Electrocardiogram Location (CC, EKG) |
