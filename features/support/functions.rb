...
#   directory_name="#{Dir.pwd}/features/support/Download_Reports"
...
#     end
#   }
#   Dir.new("#{Dir.pwd}/features/support/Download_Reports").each { |download_file_name|
#     if download_file_name.include? "#{file_name}"
#       File.delete("#{Dir.pwd}/features/support/Download_Reports/"+download_file_name)
#     end
#   }
# end
# 
