...
Feature: BTRIS Radiology Reference List Report
  ...
  #Login to the system.
    ...
    Examples:
      ...
      | Radiology Test Template | btris_test2 | Radiology Test Template | BTRIS_TEST2 - TEST2 null | Radiology and Imaging Procedure Observation | SH_Radiology_New_Search_Term_List.xlsx | New Reference List DN | MM/DD/YYYY          | Radiology_New_Reference_List.xlsx |
  ...
  #Login to the system.
    ...
    Examples:
      ...
      | T - Radiology Test Template | btris_test2 | 10               | 790                   | T - New Reference List DN | 880                  | No records found  | MM/DD/YYYY          | Radiology_New_Reference_List.xlsx | BTRIS_TEST2 - TEST2 null | Radiology and Imaging Procedure Observation | SH_Radiology_New_Search_Term_List.xlsx | New Reference List DN | Radiology Test Template |
  ...
  #Login to the system.
    ...
    Examples:
      | Labs                        | User_Name   | Number of Values | Number of Days Before | Reference Name            | Number of Days After | Validation Record | Reference Date Type | Reference Term Document           | User                     | Domain                                      | Search Term Document                   | New Reference Name    | List Name               |
      | T - Radiology Test Template | btris_test2 | 15               | 210                   | T - New Reference List DN | 210                  | No records found  | MM/DD/YYYY          | Radiology_New_Reference_List.xlsx | BTRIS_TEST2 - TEST2 null | Radiology and Imaging Procedure Observation | SH_Radiology_New_Search_Term_List.xlsx | New Reference List DN | Radiology Test Template |
  ...
  #Login to the system.
    ...
    Examples:
      | Labs                        | User_Name   | Number of Values | Number of Days Before | Reference Name            | Number of Days After | Validation Record | Reference Date Type | Reference Term Document           | User                     | Domain                                      | Search Term Document                   | New Reference Name    | List Name               |
      | T - Radiology Test Template | btris_test2 | 5                | 300                   | T - New Reference List DN | 330                  | No records found  | MM/DD/YYYY          | Radiology_New_Reference_List.xlsx | BTRIS_TEST2 - TEST2 null | Radiology and Imaging Procedure Observation | SH_Radiology_New_Search_Term_List.xlsx | New Reference List DN | Radiology Test Template |
  ...
  #Login to the system.
    ...
    Examples:
      | Labs                        | User_Name   | Number of Values | Number of Days Before | Reference Name            | Number of Days After | Validation Record | Reference Date Type | Reference Term Document           | User                     | Domain                                      | Search Term Document                   | New Reference Name    | List Name               |
      | T - Radiology Test Template | btris_test2 | 1                | 250                   | T - New Reference List DN | 225                  | No records found  | MM/DD/YYYY          | Radiology_New_Reference_List.xlsx | BTRIS_TEST2 - TEST2 null | Radiology and Imaging Procedure Observation | SH_Radiology_New_Search_Term_List.xlsx | New Reference List DN | Radiology Test Template |
  ...
  #Login to the system.
    ...
    Examples:
      | Labs                        | User_Name   | Number of Values | Number of Days Before | Reference Name            | Number of Days After | Validation Record | Reference Date Type | Reference Term Document           | User                     | Domain                                      | Search Term Document                   | New Reference Name    | List Name               |
      | T - Radiology Test Template | btris_test2 | 7                | 365                   | T - New Reference List DN | 365                  | No records found  | MM/DD/YYYY          | Radiology_New_Reference_List.xlsx | BTRIS_TEST2 - TEST2 null | Radiology and Imaging Procedure Observation | SH_Radiology_New_Search_Term_List.xlsx | New Reference List DN | Radiology Test Template |
  ...
  #Login to the system.
    ...
    Examples:
      | Labs                        | User_Name   | Number of Values | Number of Days Before | Reference Name            | Number of Days After | Validation Record | Reference Date Type | Reference Term Document           | User                     | Domain                                      | Search Term Document                   | New Reference Name    | List Name               |
      | T - Radiology Test Template | btris_test2 | 13               | 200                   | T - New Reference List DN | 150                  | No records found  | MM/DD/YYYY          | Radiology_New_Reference_List.xlsx | BTRIS_TEST2 - TEST2 null | Radiology and Imaging Procedure Observation | SH_Radiology_New_Search_Term_List.xlsx | New Reference List DN | Radiology Test Template |
  ...
  #Login to the system.
    ...
    Examples:
      | Labs                        | User_Name   | Number of Values | Number of Days Before | Reference Name            | Number of Days After | Validation Record | Reference Date Type | Reference Term Document           | User                     | Domain                                      | Search Term Document                   | New Reference Name    | List Name               |
      | T - Radiology Test Template | btris_test2 | 8                | 200                   | T - New Reference List DN | 150                  | No records found  | MM/DD/YYYY          | Radiology_New_Reference_List.xlsx | BTRIS_TEST2 - TEST2 null | Radiology and Imaging Procedure Observation | SH_Radiology_New_Search_Term_List.xlsx | New Reference List DN | Radiology Test Template |
  ...
  #Login to the system.
    ...
    And the user must see "Line 11 - Potassium Plasma Test, (CC, SOFTLAB, K5) is not in domain" text in "upload list error" field on "Btris/Portal" page
    ...
    Examples:
      ...
      | Radiology -N Test Template1 | btris_test2 | Radiology -N Test Template1 | BTRIS_TEST2 - TEST2 null | Radiology and Imaging Procedure Observation | Search_Tearm_List_Data1.xlsx | Reference List2 -N DN | MM/DD/YYYY          | Radiology_New_Reference_List.xlsx | Reference_List_Negative_Template.xlsx | Radiology_New_Search_Term_List.xlsx |
