...
@Subject_List_Clinical_Doc_Test
Feature: BTRIS Clinical Documents Template Report


  @Reference_List_Clinical_1.1

  Scenario Outline: 1.1 Adding Search Term List Document and Reference List Documents for Clinical Doc FT.
  #Login to the system.
    ...
    Examples:
      ...
      | Clinical Documents 01 | btris_test2 | Clinical Documents 01 | BTRIS_TEST2 - TEST2 null | Clinical Documents | Clinical_Doc_FT_Template.xlsx |
