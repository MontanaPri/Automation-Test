...
@NIAAA_and_NICHD_Pew_Protocol_Smoke_Test
Feature: BTRIS NIAAA And NICHD Criteria Test With New Protocol

  @NIAAA_New_Protocol-1

  Scenario Outline: 1.1 NIAAA Assessment Report testing with New protocol.
  #Login to the system.
...
#    And the user clicks on "niaa assessment value" element on "Btris/Portal" page
    ...
    Examples:
      ...
      | 000008-AA | btris_test2 | Addiction Severity Index (NIAAA, ASM_ASI) |

  @NICHD_New_Protocol-2

  Scenario Outline: 1.1 NICHD/CTDB Report Test with New protocol.
  #Login to the system.
    Given the user navigates to / on browser
    And the user must see "Log in to BTRIS" text in "btris home: landing page" field on "Btris/Portal" page
    #Login to the BTRIS system.
